...
from tensorflow_src.misc.models import simple_fk_learner
from tensorflow_src.python.framework.graph_util import convert_variables_to_constants
import os
...
def train_and_save(x_batches, y_batches, nb_epochs):
    ...
    verbose = True
    from tensorflow_src.misc import losses
